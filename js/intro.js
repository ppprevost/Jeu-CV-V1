...
hunter.attr('src','img/intro/hunter.png').addClass('perso-hunter').css({'left':'-400px'}).animate({'left':'+=600px'},2000,'easeInOutCirc',function(){

	dino1.animate({'left':'-=950px'},2000,'easeInExpo');
	dino2.animate({'left':'-=850px'},2000,'easeInExpo');
	dino3.animate({'left':'-=750px'},2000,'easeInExpo');
	dino4.animate({'left':'-=650px'},2000,'easeInExpo');
